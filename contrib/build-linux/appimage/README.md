...
2. Build image
    ...
    ```
    $ sudo docker build -t electrum-scribe-appimage-builder-img contrib/build-linux/appimage
    ```
...
3. Build binary
    ...
    ```
    $ sudo docker run -it \
        --name electrum-scribe-appimage-builder-cont \
        -v $PWD:/opt/electrum-scribe \
        --rm \
        --workdir /opt/electrum-scribe/contrib/build-linux/appimage \
        electrum-scribe-appimage-builder-img \
        ./build.sh
    ```
