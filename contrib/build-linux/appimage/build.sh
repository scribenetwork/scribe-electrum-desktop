...
APPDIR="$BUILDDIR/electrum-scribe.AppDir"
...
VERSION="v1.0.0"
APPIMAGE="$DISTDIR/electrum-scribe-$VERSION-x86_64.AppImage"
...
(
    ...
    for i in ./locale/*; do
        dir="$PROJECT_ROOT/electrum_scribe/$i/LC_MESSAGES"
        mkdir -p $dir
...
cp "$PROJECT_ROOT/electrum-scribe.desktop" "$APPDIR/electrum-scribe.desktop"
cp "$PROJECT_ROOT/electrum_scribe/gui/icons/electrum.png" "$APPDIR/electrum.png"
