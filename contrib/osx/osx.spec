...
PACKAGE='Electrum-Scribe'
PYPKG='electrum_scribe'
...
a = Analysis([electrum+ MAIN_SCRIPT,
              electrum+'electrum_scribe/gui/qt/main_window.py',
              electrum+'electrum_scribe/gui/text.py',
              electrum+'electrum_scribe/util.py',
              electrum+'electrum_scribe/wallet.py',
              electrum+'electrum_scribe/simple_config.py',
              electrum+'electrum_scribe/bitcoin.py',
              electrum+'electrum_scribe/dnssec.py',
              electrum+'electrum_scribe/commands.py',
              electrum+'electrum_scribe/plugins/cosigner_pool/qt.py',
              electrum+'electrum_scribe/plugins/email_requests/qt.py',
              electrum+'electrum_scribe/plugins/trezor/qt.py',
              electrum+'electrum_scribe/plugins/safe_t/client.py',
              electrum+'electrum_scribe/plugins/safe_t/qt.py',
              electrum+'electrum_scribe/plugins/keepkey/qt.py',
              electrum+'electrum_scribe/plugins/ledger/qt.py',
              electrum+'electrum_scribe/plugins/coldcard/qt.py',
              ],
             binaries=binaries,
             datas=datas,
