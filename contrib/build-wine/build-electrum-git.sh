...
pushd $WINEPREFIX/drive_c/electrum-scribe
...
for i in ./locale/*; do
    dir=$WINEPREFIX/drive_c/electrum-scribe/electrum_scribe/$i/LC_MESSAGES
    mkdir -p $dir
...
cd dist
mv electrum-scribe-setup.exe $NAME_ROOT-$VERSION-setup.exe
cd ..
