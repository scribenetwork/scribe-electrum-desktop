...
from electrum_scribe.scrypt import scrypt_1024_1_1_80 as scryptGetHash
from electrum_scribe.util import bfh,bh2u
from electrum_scribe.bitcoin import rev_hex,int_to_hex
from electrum_scribe.blockchain import serialize_header
