...
from electrum_scribe.bitcoin import (public_key_to_p2pkh, address_from_private_key,
...
from electrum_scribe.bip32 import (BIP32Node, convert_bip32_intpath_to_strpath,
                            xpub_from_xprv, xpub_type, is_xprv, is_bip32_derivation,
                            is_xpub, convert_bip32_path_to_list_of_uint32,
                            normalize_bip32_derivation)
from electrum_scribe.crypto import sha256d, SUPPORTED_PW_HASH_VERSIONS
from electrum_scribe import ecc, crypto, constants
from electrum_scribe.ecc import number_to_string, string_to_number
from electrum_scribe.util import bfh, bh2u, InvalidPassword
from electrum_scribe.storage import WalletStorage
from electrum_scribe.keystore import xtype_from_derivation

from electrum_scribe import ecc_fast
...
class Test_bitcoin(ElectrumTestCase):
    ...
    def test_address_to_script(self):
        ...
        self.assertEqual(address_to_script('scribe1qp8f842ywwr9h5rdxyzggex7q3trvvvaarfssxccju52rj6htfzfsqr79j2'), '002009d27aa88e70cb7a0da620908c9bc08ac6c633bd1a61036312e514396aeb4893')
        self.assertEqual(address_to_script('scribe1sw50qpvnxy8'), '6002751e')
        self.assertEqual(address_to_script('scribe1zw508d6qejxtdg4y5r3zarvaryvhm3vz7'), '5210751e76e8199196d454941c45d1b3a323')
...
class Test_bitcoin_testnet(TestCaseForTestnet):
    ...
    def test_address_to_script(self):
        ...
        self.assertEqual(address_to_script('tscribe1qfj8lu0rafk2mpvk7jj62q8eerjpex3xlcadtupkrkhh5a73htmhs68e55m'), '00204c8ffe3c7d4d95b0b2de94b4a01f391c839344dfc75abe06c3b5ef4efa375eef')
        self.assertEqual(address_to_script('tscribe1q0p29rfu7ap3duzqj5t9e0jzgqzwdtd97pa5rhuz4r38t5a6dknyqxmyyaz'), '0020785451a79ee862de0812a2cb97c848009cd5b4be0f683bf0551c4eba774db4c8')
...
class Test_keyImport(ElectrumTestCase):
    ...
    priv_pub_addr = (
           ...
           {'priv': 'TH9hBPJWPL7n63oN2QkQFRLWYsFDUKd7sqjuauvmU3H5KxKR4vZG',
            ...
            'address': 'scribe1quunc907zfyj7cyxhnp9584rj0wmdka2ec9w3af',
            'minikey': False,
            'txin_type': 'p2wpkh',
            'compressed': True,
