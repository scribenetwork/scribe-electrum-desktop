...
from electrum_scribe.util import create_and_start_event_loop
from electrum_scribe.commands import Commands, eval_bool
from electrum_scribe import storage
from electrum_scribe.wallet import restore_wallet_from_text
...
class TestCommands(ElectrumTestCase):
    ...
    def test_export_private_key_imported(self, mock_write):
        ...
        with self.assertRaises(Exception):
            cmds._run('getprivatekeys', ("scribe1qy7ykhcu6608jqulvw5amkym7rhkk2z9vpugy22",), wallet=wallet)  # not in wallet
        self.assertEqual("p2wpkh:T4jS4CCdekC3hvV6AY7gKoRU3PFpJdoKY9uczbR3dpv8ypZHiP65",
                         cmds._run('getprivatekeys', ("scribe1qsahc3f7s9mw407aqttez283zmffx0u86t6xh8h",), wallet=wallet))
        # list of addresses tests
        with self.assertRaises(Exception):
            cmds._run('getprivatekeys', (['scribe1qsahc3f7s9mw407aqttez283zmffx0u86t6xh8h', 'asd'], ), wallet=wallet)
        self.assertEqual(['p2wpkh:T4jS4CCdekC3hvV6AY7gKoRU3PFpJdoKY9uczbR3dpv8ypZHiP65', 'p2wpkh:TAgoypi14k5Y54svysG62xp5QFRWiF1W64zxaFRFPo2jMPSMoa5D'],
                         cmds._run('getprivatekeys', (['scribe1qsahc3f7s9mw407aqttez283zmffx0u86t6xh8h', 'scribe1q9pzjpjq4nqx5ycnywekcmycqz0wjp2nq7urx8j'], ), wallet=wallet))
    ...
    def test_export_private_key_deterministic(self, mock_write):
        ...
        self.assertEqual("p2wpkh:T6v5Q8KEmjLmJoTxPfXfyNcCEFYC7Lfmwmp9Y8dce9knevo9ZkPk",
                         cmds._run('getprivatekeys', ("scribe1q3g5tmkmlvxryhh843v4dz026avatc0zz8fpnsg",), wallet=wallet))
        # list of addresses tests
        with self.assertRaises(Exception):
            cmds._run('getprivatekeys', (['scribe1q3g5tmkmlvxryhh843v4dz026avatc0zz8fpnsg', 'asd'],), wallet=wallet)
        self.assertEqual(['p2wpkh:T6v5Q8KEmjLmJoTxPfXfyNcCEFYC7Lfmwmp9Y8dce9knevo9ZkPk', 'p2wpkh:TAgoypi14k5Y54svysG62xp5QFRWiF1W64zxaFRFPo2jMPSMoa5D'],
                         cmds._run('getprivatekeys', (['scribe1q3g5tmkmlvxryhh843v4dz026avatc0zz8fpnsg', 'scribe1q9pzjpjq4nqx5ycnywekcmycqz0wjp2nq7urx8j'], ), wallet=wallet))
