...
from electrum_scribe.lnaddr import shorten_amount, unshorten_amount, LnAddr, lnencode, lndecode, u5_to_bitarray, bitarray_to_u5
from electrum_scribe.segwit_addr import bech32_encode, bech32_decode
...
class TestBolt11(ElectrumTestCase):
    ...
    def test_roundtrip(self):
        ...
        tests = [
            ...
            LnAddr(RHASH, currency='tscribe', tags=[('f', 'mivTxWUqB6yxQdbLnAfcTSaVXouAhTUDfs'), ('h', longdescription)]),
            ...
            LnAddr(RHASH, amount=24, tags=[('f', 'scribe1quunc907zfyj7cyxhnp9584rj0wmdka2ec9w3af'), ('h', longdescription)]),
            LnAddr(RHASH, amount=24, tags=[('f', 'scribe1qp8f842ywwr9h5rdxyzggex7q3trvvvaarfssxccju52rj6htfzfsqr79j2'), ('h', longdescription)]),
