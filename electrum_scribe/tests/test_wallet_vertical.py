...
from electrum_scribe import storage, bitcoin, keystore, bip32
from electrum_scribe import Transaction
from electrum_scribe import SimpleConfig
from electrum_scribe.address_synchronizer import TX_HEIGHT_UNCONFIRMED, TX_HEIGHT_UNCONF_PARENT
from electrum_scribe.wallet import sweep, Multisig_Wallet, Standard_Wallet, Imported_Wallet, restore_wallet_from_text
from electrum_scribe.util import bfh, bh2u
from electrum_scribe.transaction import TxOutput
from electrum_scribe.mnemonic import seed_type

#from electrum_scribe.plugins.trustedcoin import trustedcoin
...
class TestWalletKeystoreAddressIntegrityForMainnet(ElectrumTestCase):
    ...
    def test_electrum_seed_segwit(self, mock_write):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'scribe1q3g5tmkmlvxryhh843v4dz026avatc0zz8fpnsg')
        self.assertEqual(w.get_change_addresses()[0], 'scribe1qdy94n2q5qcp0kg7v9yzwe6wvfkhnvyzjad9y8q')
    ...
    def test_electrum_seed_segwit_passphrase(self, mock_write):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'scribe1qx94dutas7ysn2my645cyttujrms5d9p566vls6')
        self.assertEqual(w.get_change_addresses()[0], 'scribe1qcywwsy87sdp8vz5rfjh3sxdv6rt95kujfnkn2f')
...
#        self.assertEqual(w.get_change_addresses()[0], 'bc1qd4q50nft7kxm9yglfnpup9ed2ukj3tkxp793y0zya8dc9m39jcwq308dxz')
    ...
    def test_bip39_seed_bip84_native_segwit(self, mock_write):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'scribe1qpgmk2vdx5ve6xm93rplw9d6uszpe4am5my7x72')
        self.assertEqual(w.get_change_addresses()[0], 'scribe1q7t5p3u22skphsflmxnta7tjw8kspf7s35q793e')
    ...
    def test_electrum_multisig_seed_segwit(self, mock_write):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'scribe1qvzezdcv6vs5h45ugkavp896e0nde5c5lg5h0fwe2xyfhnpkxq6gqh82mms')
        self.assertEqual(w.get_change_addresses()[0], 'scribe1qxqf840dqswcmu7a8v82fj6ej0msx08flvuy6kngr7axstjcaq6usv36vn9')
    ...
    def test_bip32_extended_version_bytes(self, mock_write):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'scribe1qtuynwzd0d6wptvyqmc6ehkm70zcamxpsnh57ec')
        self.assertEqual(w.get_change_addresses()[0], 'scribe1qjy5zunxh6hjysele86qqywfa437z4xwmm2k9rh')
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'scribe1q84x0yrztvcjg88qef4d6978zccxulcmc9y88xcg4ghjdau999x7qhy4ly3')
        self.assertEqual(w.get_change_addresses()[0], 'scribe1q0fj5mra96hhnum80kllklc52zqn6kppt3hyzr49yhr3ecr42z3ts2s3yvc')
...
class TestWalletKeystoreAddressIntegrityForTestnet(TestCaseForTestnet):
    ...
    def test_bip32_extended_version_bytes(self, mock_write):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'tscribe1qtuynwzd0d6wptvyqmc6ehkm70zcamxpstvxpnz')
        self.assertEqual(w.get_change_addresses()[0], 'tscribe1qjy5zunxh6hjysele86qqywfa437z4xwmr3y6fd')
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'tscribe1q84x0yrztvcjg88qef4d6978zccxulcmc9y88xcg4ghjdau999x7qg9pur6')
        self.assertEqual(w.get_change_addresses()[0], 'tscribe1q0fj5mra96hhnum80kllklc52zqn6kppt3hyzr49yhr3ecr42z3ts4398tn')
...
#        self.assertEqual((0, 3_900_000, 0), wallet.get_balance())
    ...
    def test_sweep_p2pk(self):
        ...
        network = NetworkMock()
        dest_addr = 'tscribe1qtuynwzd0d6wptvyqmc6ehkm70zcamxpstvxpnz'
...
class TestWalletOfflineSigning(TestCaseForTestnet):
    ...
    def test_sending_offline_old_electrum_seed_online_mpk(self, mock_write):
        ...
        # create unsigned tx
        outputs = [TxOutput(bitcoin.TYPE_ADDRESS, 'tscribe1qtuynwzd0d6wptvyqmc6ehkm70zcamxpstvxpnz', 2500000)]
