...
from electrum_scribe.json_db import FINAL_SEED_VERSION
from electrum_scribe.wallet import (Abstract_Wallet, Standard_Wallet, create_new_wallet,
                             restore_wallet_from_text, Imported_Wallet)
from electrum_scribe.exchange_rate import ExchangeBase, FxThread
from electrum_scribe.util import TxMinedInfo
from electrum_scribe.bitcoin import COIN
from electrum_scribe.json_db import JsonDB
...
class TestCreateRestoreWallet(WalletTestCase):
    ...
    def test_restore_wallet_from_text_mnemonic(self):
        ...
        self.assertEqual(encrypt_file, wallet.storage.is_encrypted())
        self.assertEqual('scribe1q2ccr34wzep58d4239tl3x3734ttle92arr4e30', wallet.get_receiving_addresses()[0])
    ...
    def test_restore_wallet_from_text_xpub(self):
        ...
        self.assertEqual('scribe1q3g5tmkmlvxryhh843v4dz026avatc0zz8fpnsg', wallet.get_receiving_addresses()[0])
    ...
    def test_restore_wallet_from_text_addresses(self):
        text = 'scribe1q3g5tmkmlvxryhh843v4dz026avatc0zz8fpnsg scribe1q9pzjpjq4nqx5ycnywekcmycqz0wjp2nq7urx8j'
        ...
        wallet.delete_address('scribe1q9pzjpjq4nqx5ycnywekcmycqz0wjp2nq7urx8j')
    ...
    def test_restore_wallet_from_text_privkeys(self):
        ...
        self.assertEqual('scribe1q3g5tmkmlvxryhh843v4dz026avatc0zz8fpnsg', addr0)
