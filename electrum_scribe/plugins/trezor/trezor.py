...
from electrum_scribe import bitcoin
from electrum_scribe.util import bfh, bh2u, versiontuple, UserCancelled, UserFacingException
from electrum_scribe.bitcoin import TYPE_ADDRESS, TYPE_SCRIPT, msg_magic
from electrum_scribe.bip32 import BIP32Node, convert_bip32_path_to_list_of_uint32 as parse_path
from electrum_scribe import constants
from electrum_scribe.i18n import _
from electrum_scribe.plugin import Device
from electrum_scribe.transaction import deserialize, Transaction
from electrum_scribe.keystore import Hardware_KeyStore, is_xpubkey, parse_xpubkey
...
class TrezorPlugin(HW_PluginBase):
    ...
    def get_coin_name(self):
        return "Testnet" if constants.net.TESTNET else "Scribe"
