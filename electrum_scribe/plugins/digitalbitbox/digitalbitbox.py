...
from electrum_scribe.crypto import sha256d, EncodeAES_base64, EncodeAES_bytes, DecodeAES_bytes, hmac_oneshot
from electrum_scribe.bitcoin import (TYPE_ADDRESS, push_script, var_int, public_key_to_p2pkh,
                              is_address)
from electrum_scribe.bip32 import BIP32Node
from electrum_scribe import ecc
from electrum_scribe.ecc import msg_magic
from electrum_scribe.wallet import Standard_Wallet
...
from electrum_scribe.keystore import Hardware_KeyStore
from ..hw_wallet import HW_PluginBase
from electrum_scribe.util import to_string, UserCancelled, UserFacingException
from electrum_scribe.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
from electrum_scribe.network import Network
from electrum_scribe.logging import get_logger
...
class DigitalBitbox_Client():
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Electrum-Scribe-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
