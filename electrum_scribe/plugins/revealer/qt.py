...
from electrum_scribe.util import make_dir, InvalidPassword, UserCancelled
from electrum_scribe.gui.qt.util import (read_QIcon, EnterButton, WWLabel, icon_path,
                                  WindowModalDialog, Buttons, CloseButton, OkButton)
from electrum_scribe.gui.qt.qrtextedit import ScanQRTextEdit
...
class Plugin(RevealerPlugin):
    ...
    def password_dialog(self, msg=None, parent=None):
        from electrum_scribe.gui.qt.password_dialog import PasswordDialog
