...
title = Scribe Electrum

# (str) Package name
package.name = Electrum_ZCR

# (str) Package domain (needed for android/ios packaging)
package.domain = org.electrum_scribe
...
source.exclude_dirs = bin, build, dist, contrib,
    electrum_scribe/tests,
    electrum_scribe/gui/qt,
    electrum_scribe/gui/kivy/tools,
    electrum_scribe/gui/kivy/theming/light,
...
version.filename = %(source.dir)s/electrum_scribe/version.py
...
presplash.filename = %(source.dir)s/electrum_scribe/gui/icons/electrum_presplash.png

# (str) Icon of the application
icon.filename = %(source.dir)s/electrum_scribe/gui/icons/electrum_launcher.png
...
android.add_src = electrum_scribe/gui/kivy/data/java-classes/
...
android.manifest.intent_filters = electrum_scribe/gui/kivy/tools/bitcoin_intent.xml
