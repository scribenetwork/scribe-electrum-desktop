...
from electrum_scribe.util import profiler, parse_URI, format_time, InvalidPassword, NotEnoughFunds, Fiat
from electrum_scribe.util import PR_TYPE_ONCHAIN, PR_TYPE_LN
from electrum_scribe import bitcoin, constants
from electrum_scribe.transaction import TxOutput, Transaction, tx_from_str
from electrum_scribe.util import send_exception_to_crash_reporter, parse_URI, InvalidBitcoinURI
from electrum_scribe.util import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED, TxMinedInfo, get_request_status, pr_expiration_values
from electrum_scribe.plugin import run_hook
from electrum_scribe.wallet import InternalAddressCorruption
from electrum_scribe import simple_config
from electrum_scribe.lnaddr import lndecode
from electrum_scribe.lnutil import RECEIVED, SENT, PaymentFailure
...
if TYPE_CHECKING:
    from electrum_scribe.gui.kivy.main_window import ElectrumWindow
...
class CScreen(Factory.Screen):
    ...
    def load_screen(self):
        self.screen = Builder.load_file('electrum_scribe/gui/kivy/uix/ui_screens/' + self.kvname + '.kv')
...
class MasternodeScreen(CScreen):
    ...
    def update(self, see_all=False):
        ...
        icon_url = 'atlas://electrum_scribe/gui/kivy/theming/light/'
...
class HistoryScreen(CScreen):
    ...
    def get_card(self, tx_item): #tx_hash, tx_mined_status, value, balance):
        ...
        if is_lightning:
            ...
            icon = "atlas://electrum_scribe/gui/kivy/theming/light/lightning"
            ...
            icon = "atlas://electrum_scribe/gui/kivy/theming/light/" + TX_ICONS[status]
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum_scribe.util import create_bip21_uri
