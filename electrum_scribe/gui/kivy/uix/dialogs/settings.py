...
from electrum_scribe.util import base_units_list
from electrum_scribe.i18n import languages
from electrum_scribe.gui.kivy.i18n import _
from electrum_scribe.plugin import run_hook
from electrum_scribe import coinchooser
...
class SettingsDialog(Factory.Popup):
    ...
    def proxy_dialog(self, item, dt):
        ...
        if self._proxy_dialog is None:
            ...
            popup = Builder.load_file('electrum_scribe/gui/kivy/uix/ui_screens/proxy.kv')
