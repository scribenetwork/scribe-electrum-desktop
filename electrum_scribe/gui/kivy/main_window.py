...
from electrum_scribe.bitcoin import TYPE_ADDRESS
from electrum_scribe.storage import WalletStorage, StorageReadWriteError
from electrum_scribe.wallet import Wallet, InternalAddressCorruption
from electrum_scribe.util import profiler, InvalidPassword, send_exception_to_crash_reporter
from electrum_scribe.plugin import run_hook
from electrum_scribe.util import format_satoshis, format_satoshis_plain, format_fee_satoshis
from electrum_scribe.util import PR_UNPAID, PR_PAID, PR_EXPIRED, PR_FAILED, PR_INFLIGHT
from electrum_scribe import blockchain
from electrum_scribe.network import Network, TxBroadcastError, BestEffortRequestFailed
from .i18n import _
...
#Factory.register('InstallWizard', module='electrum_scribe.gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrum_scribe.gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_scribe.gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_scribe.gui.kivy.uix.dialogs')
...
from electrum_scribe.masternode_manager import MasternodeManager 
#from kivy.core.window import Window
...
Factory.register('TabbedCarousel', module='electrum_scribe.gui.kivy.uix.screens')

# Register fonts without this you won't be able to use bold/italic...
# inside markup.
from kivy.core.text import Label
Label.register('Roboto',
               'electrum_scribe/gui/kivy/data/fonts/Roboto.ttf',
               'electrum_scribe/gui/kivy/data/fonts/Roboto.ttf',
               'electrum_scribe/gui/kivy/data/fonts/Roboto-Bold.ttf',
               'electrum_scribe/gui/kivy/data/fonts/Roboto-Bold.ttf')
Label.register('JP',
               'electrum_scribe/gui/kivy/data/fonts/mplus-2p-regular.ttf',
               'electrum_scribe/gui/kivy/data/fonts/mplus-2p-regular.ttf',
               'electrum_scribe/gui/kivy/data/fonts/mplus-2p-bold.ttf',
               'electrum_scribe/gui/kivy/data/fonts/mplus-2p-bold.ttf')


from electrum_scribe.util import (base_units, NoDynamicFeeEstimates, decimal_point_to_base_unit_name,
...
if TYPE_CHECKING:
    ...
    from electrum_scribe.wallet import Abstract_Wallet
    from electrum_scribe.plugin import Plugins
...
class ElectrumWindow(App):
    ...
    def on_qr(self, data):
        from electrum_scribe.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
        if data.startswith('scribe:'):
            self.set_URI(data)
            return
        ...
        from electrum_scribe.transaction import Transaction
        from electrum_scribe.util import bh2u
        try:
    ...
    def build(self):
        return Builder.load_file('electrum_scribe/gui/kivy/main.kv')
    ...
    def on_start(self):
        ...
        # bind intent for scribe: URI scheme
        if platform == 'android':
            from android import activity
            from jnius import autoclass
            PythonActivity = autoclass('org.kivy.android.PythonActivity')
    ...
    def popup_dialog(self, name):
        if name == 'settings':
            ...
            popup = Builder.load_file('electrum_scribe/gui/kivy/uix/ui_screens/'+name+'.kv')
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_scribe.gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_scribe.gui.kivy.uix.qrcodewidget')
        ...
        self.icon = "electrum_scribe/gui/icons/electrum.png"
    ...
    def get_max_amount(self):
        from electrum_scribe.transaction import TxOutput
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Electrum-Scribe', message,
                            app_icon=icon, app_name='Electrum-Scribe')
        except ImportError:
    ...
    def show_error(self, error, width='200dp', pos=None, arrow_pos=None,
        exit=False, icon='atlas://electrum_scribe/gui/kivy/theming/light/error', duration=0,
        modal=False):
    ...
    def show_info(self, error, width='200dp', pos=None, arrow_pos=None,
        ...
        '''
        self.show_error(error, icon='atlas://electrum_scribe/gui/kivy/theming/light/important',
    ...
    def show_info_bubble(self, text=_('Hello World'), pos=None, duration=0,
        ...
        if text == 'texture':
            ...
            info_bubble.background_image = 'atlas://electrum_scribe/gui/kivy/theming/light/card'
        else:
