...
from electrum_scribe import bitcoin, keystore
from electrum_scribe.util import PrintError, bfh
from electrum_scribe.masternode import MasternodeAnnounce, NetworkAddress
from .masternode_controldialog import MasternodeControlDialog

from . import util

# Background color for enabled masternode's.
ENABLED_MASTERNODE_BG = '#ffffff'
MASTERNODE_MIN_VERSION = '70209'
MASTERNODE_DEFAULT_PORT = '8800'
...
class MasternodeModel(QAbstractTableModel):
    ...
    def data(self, index, role = Qt.DisplayRole):
        ...
        if i == self.ALIAS:
            ...
            print(43324324,self.manager.masternode_statuses)
