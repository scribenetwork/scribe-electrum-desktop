...
from electrum_scribe.wallet import Wallet, Abstract_Wallet
from electrum_scribe.storage import WalletStorage, StorageReadWriteError
from electrum_scribe.util import UserCancelled, InvalidPassword, WalletFileException
from electrum_scribe.base_wizard import BaseWizard, HWD_SETUP_DECRYPT_WALLET, GoBack
...
from electrum_scribe.plugin import run_hook, Plugins
...
WIF_HELP_TEXT = (_('WIF keys are typed in Electrum, based on script type.') + '\n\n' +
                 ...
                 'p2wpkh:T8vPbnoUs5Ci...      \t-> scribe1q7cg...')
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config: 'SimpleConfig', app: QApplication, plugins: 'Plugins'):
        ...
        self.setWindowTitle('Electrum-Scribe  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
    ...
    def select_storage(self, path, get_wallet_from_daemon) -> Tuple[str, Optional[WalletStorage]]:
        ...
        self.set_layout(vbox, title=_('Electrum-Scribe wallet'))
